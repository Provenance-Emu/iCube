...
void VideoConfig::Refresh()
{
  ...
  iBBoxSyncMode = Config::Get(Config::GFX_BBOX_SYNC_MODE);
  ...
  bComputeVertexDecode = Config::Get(Config::GFX_USE_COMPUTE_VERTEX_DECODE);
  ...
  bNEONTextureDecode = Config::Get(Config::GFX_HACK_NEON_TEXTURE_DECODE);
