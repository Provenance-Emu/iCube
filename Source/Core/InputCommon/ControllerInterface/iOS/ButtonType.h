...
enum ButtonType
{
  ...
  WIIMOTE_IR_HIDE = 118,
  WIIMOTE_IR_RECENTER = 119,
  WIIMOTE_SWING = 120,
  WIIMOTE_SWING_UP = 121,
  WIIMOTE_SWING_DOWN = 122,
  WIIMOTE_SWING_LEFT = 123,
  WIIMOTE_SWING_RIGHT = 124,
  WIIMOTE_SWING_FORWARD = 125,
  WIIMOTE_SWING_BACKWARD = 126,
  WIIMOTE_TILT = 127,
  WIIMOTE_TILT_FORWARD = 128,
  WIIMOTE_TILT_BACKWARD = 129,
  WIIMOTE_TILT_LEFT = 130,
  WIIMOTE_TILT_RIGHT = 131,
  WIIMOTE_TILT_MODIFIER = 132,
  WIIMOTE_SHAKE_X = 133,
  WIIMOTE_SHAKE_Y = 134,
  WIIMOTE_SHAKE_Z = 135,
  // Nunchuk
