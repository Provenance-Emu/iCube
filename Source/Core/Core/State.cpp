...
// iCube: upstream is 191 (PR 14668); +1 for the bounded Auto VISkip gating state in
// VideoInterface::DoState. Keep this strictly above upstream's value at every merge.
constexpr u32 STATE_VERSION = 192;
